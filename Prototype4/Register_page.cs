...
namespace Prototype4
{
    public partial class Register_page : Form
    {
        ...
        {
            if (Register_username.Text == "" || Register_password.Text == "" || Register_password2.Text == "")// checks if any of the textboxes are empty
            {
            ...
            else
            {
                ...
                Priority = int.Parse(Register_comboBox.Text);
                if (Password == Password2)// checks if the password mathces withthe password but inputed in a second taxtbox
                {
                    ...
                    Reg.Is_Username_Taken(Username,Password,Priority);//runs the is the username taken method
